...
{
    [Activity(Theme = "@style/AppFullScreenTheme", Label = "Icon Tab Sample", Icon = "@drawable/icon", ParentActivity = typeof(MainInterfaceActivity))]
    [MetaData("android.support.PARENT_ACTIVITY", Value = "MainInterfaceActivity")]
